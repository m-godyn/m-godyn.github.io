...
Template used: [Astrofy](https://astro.build/themes/details/astrofy/)

Special thanks to [Manuel Ernesto Garcia](https://github.com/manuelernestog) for this great template.
